...
$(function () {//tongji
  (function () {
    ...
    hm.src = _hmUrl+"36603a3ac67228cfc7686cc8754897ab";
...
if (typeof _webInfo != "undefined") {//add tongji for everyBJ
  ...
  if (bjname != '') {
    switch (bjname){
        ...
        break; 
        case 'zzj':
        hm.src = _hmUrl+"dd2ad46f4ef3fdcf47624ff444115676";
        break; 
        case 'xiaodi':
        hm.src = _hmUrl+"0a6ef5565df801de4dc7e72139b5c64b";
        break; 
        case 'wjh':
        hm.src = _hmUrl+"fcd5a50138254f2f9d2ffddfdc2ff9db";
        break; 
        case 'qmy':
        hm.src = _hmUrl+"2cc6c2d97630c26827e60a2893e924fd";
        break; 
    }
    if (hm.src != '') {
      var s = document.getElementsByTagName("script")[0];
