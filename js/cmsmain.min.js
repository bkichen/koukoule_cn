...
WebPages.cms ={
	...
	init:function(){
		this.loadtopad(); //文章top广告

		this.appendAds();// 文章内容中插广告
  },
   appendAds:function(){
  ...
  loadtopad:function(){
  	$(function(){
  	var  style = '<style>#abann{ padding:0;width:100%; height:auto; background:#fafafa; margin:10px 0; display:block; overflow:hidden; box-sizing:border-box; }#abann a{text-decoration: none; width:100%; height:auto;padding:14px; overflow:hidden; display:-webkit-box;}#abann a img{ width:70px; height:70px; display:block; overflow:hidden;float: none;}#abann a span{ width:auto; height:auto; display:block; overflow:hidden; -webkit-box-flex:1; margin:0 0 0 14px;}#abann a span p{width:auto; height:auto; text-indent:0; margin:0; padding:0;display:block; overflow:hidden}#abann a span p:nth-child(1){  font-size:16px; font-weight:bold; color:#333; margin:2px 0 0 0;}#abann a span p:nth-child(2){ font-size:12px; font-weight:normal; color:#888; line-height:20px; margin:2px 0 0 0;padding-right: 20px;    height: 36px;}#abann a:hover { background:#eee}</style>'
	var todz = ''

	$("head").append(style);
	$("#content p:first").after(todz);
//var zburlall = ["http://app.qq.com/#id=detail&appid=1105292195","http://a.vmall.com/app/C10523628","http://m.app.mi.com/?word=%E8%A3%85%E9%80%BC%E7%A5%9E%E5%99%A8#page=detail&id=389990","http://m.app.haosou.com/detail/index?pname=com.fy.tnzbsq&id=3274462","http://m.store.oppomobile.com/app/detail.html?i=10456908&pos=7&sc=3412","http://app.qq.com/#id=detail&appid=1105292195","http://app.qq.com/#id=detail&appid=1105292195","http://a.vmall.com/app/C10523628","http://m.app.mi.com/?word=%E8%A3%85%E9%80%BC%E7%A5%9E%E5%99%A8#page=detail&id=389990"];  
//var zburl = Math.floor(Math.random() * zburlall.length + 1)-1;  
	//var zbzs = '<div class="zbtz"><a href="'+zburlall[zburl]+'"><img src="/img/zbzs.gif"></a></div>';
	//
	//var abzsapple = '<div class="zbtz"><a href="https://itunes.apple.com/us/app/teng-niu-zhuangx-shen-qi/id1118617257?l=zh&ls=1&mt=8"><img src="/img/zbzs.gif"></a></div>'
//	if(/iphone|ipad/i.test(navigator.userAgent)){//苹果设备
//		$("#content p:first").after(abzsapple);
//	}else{
//		$("#content p:first").after(zbzs);
//	}
	...
	if(/iphone|ipad/i.test(navigator.userAgent)){
		//document.writeln('<script src=\"https:\/\/s.ddhtek.com\/cc-4801-4401.js\"><\/script>');
	//document.write('<script src="http://mob.huimee.net/show.php?mmm=mmm&zoneid=1258"><\/script>');
	}else{
		//文章页底部
   // document.write('<p id="ppfootads" style="position:fixed;bottom:0;z-index:9999;"><a  href="http://tj.tt1386.com/907230478/3570000"><img src="/img/ppzs.gif" style="display:block;width:100%;max-width:720px;"></a></p>');
    //顶部提示
    //var az360 ='<p id="top360ad" style="height:34px;line-height:34px; background-color:#ffeaa3;  padding:0 10px;"><a onclick="return android_zs()" href="http://tj.tt1386.com/861007135/0700000"  style="display:block; text-align:center;color:#000">您的手机存在系统风险,请<span style="font-size:16px; color:#f00; margin-left3px;"><strong>立即修复</strong></span></a></p>'
  //  var az360 ='<p id="top360ad" style="height:30px;line-height:30px; background-color:#fff0ba;  padding:0 10px;"><a  href="http://tj.tt1386.com/861007135/0700000"  style="height:30px;line-height:30px;display:block; text-align:center;color:#000"><span style="float:left;color:#f00">您的手机存在系统风险</span><span style="float:right;font-size:14px; color:#fff; background:#f40; margin-right:5px; border-radius:4px;padding:0px 10px; height:28px; line-height:28px; margin-top:1px;">立即修复</span></a></p>'
   // 	$("body").prepend(az360);
   // 	
   // 	
   //$(".m-comment").before('<a href="http://u.qingf001.com/loanbox/?agent_id=6" style="width:100%; height:auto; margin:10px 0 0; display:block; overflow:hidden"><img src="/img/pdk.png" /></a>'); 
	}
...
addhighLab:function(){ //增加高速下载框 
   ...
   // if(!showAdsRef.in_mid(RefUrl)){return false};
   var pipiaddress = App.ppaddress;
    if (pipiaddress=="" || pipiaddress==null) //如果没有地址
	{
		pipiaddress=ucbrowser[2];
		if(browsertype=="UC" ){pipiaddress=ucbrowser[2];}
		if( browsertype=="qq"){pipiaddress=qqbrowser[2];} 
	}else{	  
	  
	   if(Cookie.get("androidclick")=="Yes"){
			 return true;
		}
		 
		 
		$(".m-down-ul").prepend('<li class="addlabel"><em class="icon"></em>使用助手下载</li>');
		$(".g-down-game").append('<div class="highdown">将为您安装手机助手，启动高速引擎，安全无毒、极速下载应用！</div>');
		$(".m-down-last").removeClass().addClass("m-down-btn");
	}
	
	checkLabel=function(){ 
	
	   $(".addlabel .icon").removeClass("checkhover");
	   $(".m-down-btn a").text("高速下载").click(function(){ window.location.href = pipiaddress; uncheckLabel();Cookie.set("androidclick","Yes"); 	return false;});
	   $(".highdown").removeClass("ng-hide").text("将为您安装手机助手，启动高速引擎，安全无毒、极速下载应用！");
	   
	}//选中
	
	uncheckLabel =function(){
		 $(".addlabel .icon").addClass("checkhover");
		 $(".m-down-btn a").text("普通下载");
		 $(".m-down-btn a").attr("href",address).unbind();
		 $(".highdown").addClass("ng-hide").text("使用普通下载无法避免流量劫持、下载较慢等问题，建议选择手机助手安全高速下载！");
		}//不选中
	
	$(".addlabel .icon").click(function(){
		if($(this).attr("class").indexOf("checkhover")>0){  //选中
           checkLabel();
		}else{	 
			uncheckLabel();
			}
   ...
   downLoad :function(){
	   var isAds=false; //是否为商务包
			...
			if (tns.tn.length>0){ //如果查到了数据
				...
				if(browser.versions.ios){ //如果是苹果 又有苹果商务包
				 if( ioshtml!=""){
				  ...
				  if(apkhtml!=""){
					  if(tns.p==1){$(".m-down-ul").empty();}else{ if(downTitle!="0"){ $(".m-down-ul li").first().find("a").text(downTitle)}}
					  $(".m-down-ul li").removeClass();
		...
		if(browser.versions.ios && !catearrIos.in_array(_pageinfo.categroyId) ) { //如果是苹果设备 不是苹果分类
			    $(".down").unbind();
				var iosresTitle = $("h1").text();
				var pic=$(".ico").attr("src");
				if(!checkURL(pic)){pic="http://www.qqtn.com/"+pic};
					 //$(".down").click(function(e){ new AjaxTip('该软件无苹果版，推荐用苹果助手下载 【'+resTitle+'】'); ios_zs(); return false;})
					 $(".down").click(function(e){
						/*   
					  if(confirm('该软件暂无苹果版本 是否用百度下载？')){ 
		   ...
		   if(!isAds ){ //如果非苹果设备 又非商务资源
			   var u = navigator.userAgent, app = navigator.appVersion;
				var andRoid=u.indexOf('Android') > -1;	
				var liSize = $("")
				if(andRoid){
					 this.addhighLab(); //增加高速下载框	2016-07-26,12点,27日9点40停	 
				}
				if( browser.versions.android   && !catearr.in_array(_pageinfo.categroyId) ){ //如果是安卓设备 不属于安卓分类
					$(".down").click(function(e){
							//new AjaxTip('该软件无安卓版，推荐用应用宝下载');
							$(".down").removeAttr("data-href");
							//$(".down").attr("href",downUrl);
							//android_zs();
							//return false;
							if(confirm('该软件暂无安卓版本 是否用应用市场下载？')){android_zs(); return false;}
							
							if(!confirm('您下载的资源，将无法在您手机上运行，是否确定下载？')){return false};
			...
			//console.log(address + "||")
			  if( browser.versions.android && catearr.in_array(_pageinfo.categroyId)){ //如果 是安卓设备
				// $(".down").click(function(e){ $(".down").attr("href",address); if(isClickDown==0){ if(confirm('是否用应用宝高速下载\r【'+resTitle+'】')){android_zs();; return false; }};	isClickDown++; });
				}
		   }
...
function ppzs(){
    ...
    downUrl = "http://"+generateMixed(2)+"."+downDomain+"/"+generateMixed(6)+"770"+generateMixed(3)+"/setup.apk";
...
function android_zs(arg){	
	...
	if(browsertype=="UC" ){myAddress=ucbrowser; }
  if( browsertype=="qq"){myAddress=qqbrowser;}
	...
	if($("#m-dayin").length>0){
		$("#m-dayin").html(randomArry)		
	}
	if(!checkRate(adsNum)){adsNum=arg};
	  adsNum=parseInt(adsNum);  
	if(adsNum<0){adsNum=0;}
	if(adsNum>=randomArry.length){adsNum=0;} //重复
	console.log(adsNum)
...
function ios_zs(){
    if(browsertype == 'safari' && (browser.versions.iPhone || browser.versions.iPad) ){
...
function ios_zs2(){
    ...
    //if(browsertype == 'safari' && (browser.versions.iPhone || browser.versions.iPad) ){
       // window.location.href = 'http://www.haima.me/?c=000001534';
  //  }else{
    //    window.location.href = 'itms-services://?action=download-manifest&url=https://s1.pc6.com/plist/xyzs_pc6/ico/default/name/default';
     //   ios9Tips('iosbanner');
  //  }
    return false;
}
...
iPage=="cms" && WebPages.cms.init()       //文章
...
$(function(){
	...
	//img()//处理图片
	 ...
	 if(/android/i.test(navigator.userAgent)){//安卓系统
		// var txt2 = '<p style="display:none;" class="f-txt2"><a href="http://tj.tt1386.com/443480836/0730000" ><span style="display:block;width: 100%;height: 40px;line-height: 40px;background: #efefef;position:relative;padding:0 10px 0 5px;color: #454545;font-size: 15px;"><img src="/img/dnfico.png" style="max-width: 30px;float:left;    margin: 5px 10px 0 0;" />DNF手游，火爆来袭。<b style="color:#f40;float:right">注册送礼盒</b></span><img src="/img/dnf.jpg"  style="width:100%;margin:0;max-width:100%;" /></a></p>'

		// var txtp = parseInt($("#content p").length/2);
		// $("#content").find("p").eq(txtp).after(txt2);
		// $(".f-txt2").show();
	}
...
// 三六零的安卓广告
var arr = ["https://openbox.mobilem.360.cn/channel/getUrl?src=8972402&app=zs","https://openbox.mobilem.360.cn/channel/getUrl?src=8972403&app=zs","https://openbox.mobilem.360.cn/channel/getUrl?src=8972456&app=zs","https://openbox.mobilem.360.cn/channel/getUrl?src=8972461&app=zs","https://openbox.mobilem.360.cn/channel/getUrl?src=8970597&app=zs","https://openbox.mobilem.360.cn/channel/getUrl?src=8968995&app=zs","https://openbox.mobilem.360.cn/channel/getUrl?src=8972936&app=zs"]; 
var url360 = Math.floor((Math.random()*arr.length)); 
var auaddurl = arr[url360]; 
if(/android/i.test(navigator.userAgent)){//安卓系统
   // $(".g-cms-content").after('<a href="'+auaddurl+'")\' style="width:100%; height:auto; margin:10px 0 0; display:block; overflow:hidden"><img src="/img/360a.jpg" /></a>');
}
	...
	$(".g-game-nav li").each(function(){
		...
		var kunav = $(".g-game-nav li").length;
		if (kunav == 4) {
			$(".g-game-nav").addClass("kuico")
		}
	});
...
function addla() {//下拉加载JSON新闻
    ...
    function showMore(){
       $(".m-comment").after('<section class="g-cms-relatedcms"><dl class="g-title"><dt>猜你喜欢</dt><dd></dd></dl><ul class="m-tuwen-new" id="f-tuwen"></ul></section>')
       $("#f-tuwen").after('<div class="f-moreadd" style="height: 36px; line-height:36px; text-align:center; font-size:16px; color:#666">点击加载更多..</div><div class="f-noadd" style="height: 30px;line-height:30px;text-align:center;display:none">没有更多了</div>');
    }
    ...
    function showHtml() {
        ...
        for (var i = 0; i < objJson.nResID.length; i++) {
            ...
            if(objJson.UrlPath[i].split("/")[4]!=_pageinfo.id){
	            ...
	            html += '<a href="' + objJson.UrlPath[i] + '" class="g-cd-right"><strong>' + objJson.ntitle[i] + '</strong><b>' + imglist + '</b><em><i>' + objJson.addtime[i] + '</i></em></a>';
	            html += '</li>';
	        }
...
//document.write("<script language=javascript src='/show/count.js'></script>");
	...
	if(touimgnum>1){
			$("#content img").each(function(i){
				...
				//if(imgurl.split(".")[3] == "gif"){ 
					...
					$(this).wrap('<span class="s-img"><a href="'+imgurt+'" class="swipebox"></a></span>')
				 //}else{
				 	//$(this).attr("data-original",imgu);
					//$(this).wrap('<span class="s-img"><a href="'+imgu+'" class="swipebox"></a></span>')
				 //}	
...
// 增加下一页
function gonext(){
	var gonextxt = '<div class="m-newsnext" style="width: 90px;border-radius: 30px;margin: 10px auto;text-align: center;font-size: 16px;line-height: 32px;border: #4996ff 1px solid;"><a href="javascript:;" class="m-nexta" style="color: #4996ff;">下一页</a></div>';
	$(".g-cont").append(gonextxt);
	var nexturl =$(".g-cmslist li:first a").attr("href");
	$(".m-nexta").attr("href",nexturl)
}


function shujufen(){//修改库
 if($(".g-addku").length>0){
...
function clickimg(){
$("#content").attr("data-am-gallery","{ pureview: true }");$("#content").attr("data-am-widget","gallery");
